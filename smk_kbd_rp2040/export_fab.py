...
Output: fab/ directory + smk_kbd_rp2040_gerbers.zip -> upload the zip to PCBWay.
"""
import os, zipfile
import pcbnew
...
# smk_kbd.kicad_pcb or the wrong (2-layer, ESP32) board gets
# zone-filled and exported.
BOARD = os.path.join(HERE, "smk_kbd_rp2040.kicad_pcb")
...
# 4. zip for PCBWay
zpath = os.path.join(HERE, "smk_kbd_rp2040_gerbers.zip")
